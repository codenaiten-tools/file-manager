...
// ------------------------------------------------------------------------------------------------------------------ \\
    ...
    public static Optional<ContentType> of( final byte[] bytes ){
        Optional<ContentType> result = Optional.empty();
        final ContentTypeEnum contentTypeEnum = ContentTypeEnum.fromBytes( bytes );
        if( contentTypeEnum != null ) result = Optional.of( new ContentType( contentTypeEnum ));
        return result;
    }
